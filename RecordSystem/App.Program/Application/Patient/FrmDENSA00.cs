...
namespace SANSANG
{
    public partial class FrmDENSA00 : Form
    {
        public string strUserId;
        public string strUserName; public string strUserSurname;
        public string strUserType;

        public string strAppCode = "DENSA00";
        public string strAppName = "FrmDENSA00";
        ...
        public FrmDENSA00(string userIdLogin, string userNameLogin, string userSurNameLogin, string userTypeLogin)
        {
            try
            {
                InitializeComponent();
        ...
        private void FrmDENSA00_Load(object sender, EventArgs e)
        {
            try
            {
                int sec = 1;
        ...
        public void Clear()
        {
            try
            {
                cbbPatital.SelectedValue = "PAT600121107-3";
        ...
        public void getDataGrid(DataTable dt)
        {
            try
            {
                ...
                else
                {
                    ...
                    dtGrid = dt.DefaultView.ToTable(true, "Date", "RcptId", "Patient", "MsMoneyNameTh", "Amounts", "RcptDentalCode");
                    ...
                    Fn.showGridViewFormatFromStore(dtGrid, dataGridView,
                        ...
                        , "ผู้ป่วย", 350, true, ml, ml
                        , "วิธีชำระ", 100, true, mc, mr
        ...
        public bool SaveDetail()
        {
            try
            {
                ...
                for (int Number = 1; Number <= Item; Number++)
                {
                    ...
                    //    ExpenseDetails = "",
                    //    ExpenseItem = "ค่ารักษาพยาบาล | ค่าจัดฟัน - " + txtItemName[0].Text,
                    //    ExpenseMoney = cbbMoney.SelectedValue.ToString(),
                    //    ExpensePay = "HOS-000-0",
                    //    ExpensePaySub = "HOS0440",
                    //    ExpenseStatus = "Y",
                    //    ExpenseIncome = "0",
                    //    ExpenseRef = String.Format("{0}/{1}", txtBookId.Text, txtBookNumber.Text),
                    //    ExpenseUnit = "1",
