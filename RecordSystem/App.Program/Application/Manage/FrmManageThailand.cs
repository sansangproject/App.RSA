...
namespace SANSANG
{
    public partial class FrmManageThailand : Form
    {
        ...
        public FrmManageThailand(string userIdLogin, string userNameLogin, string userSurNameLogin, string userTypeLogin)
        {
            try
            {
                InitializeComponent();
