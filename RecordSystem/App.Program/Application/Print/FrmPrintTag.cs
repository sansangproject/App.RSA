...
namespace SANSANG
{
    public partial class FrmPrintTag : Form
    {
        ...
        public string Path = "";
        public string ReportName = "RSA-R-BARCODE00001";
        public string strQr = "";
       ...
       private dbConnection db = new dbConnection();
        ...
        public FrmPrintTag(string Code)
        {
            InitializeComponent();
            strCode = Code;
        }
        ...
        private void FrmPrintTag_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                dt.Columns.Add(new DataColumn("CODESTR", typeof(string)));
                ...
                imgQr = Barcode.QRCodeForTag(strQr, Color.Black, Color.White, "L", 1);
                BitQr = (Bitmap)imgQr;

                imgBar = Barcode.Code39(strQr, Color.Black, Color.White, 20);
